...
func Test_Node_EncodeAndHash(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"small leaf encoding": {
			...
			expectedNode: Node{
				NodeValue: []byte{0x41, 0x1, 0x4, 0x2},
			},
		...
		"large leaf encoding": {
			...
			expectedNode: Node{
				NodeValue: []byte{0xd2, 0x1d, 0x43, 0x7, 0x18, 0x17, 0x1b, 0xf1, 0x45, 0x9c, 0xe5, 0x8f, 0xd7, 0x79, 0x82, 0xb, 0xc8, 0x5c, 0x8, 0x47, 0xfe, 0x6c, 0x99, 0xc5, 0xe9, 0x57, 0x87, 0x7, 0x1d, 0x2e, 0x24, 0x5d}, //nolint:lll
			},
		...
		"small branch encoding": {
			...
			expectedNode: Node{
				Children:  make([]*Node, ChildrenCapacity),
				NodeValue: []byte{0xc1, 0x1, 0x0, 0x0, 0x4, 0x2},
			},
		...
		"large branch encoding": {
			...
			expectedNode: Node{
				Children:  make([]*Node, ChildrenCapacity),
				NodeValue: []byte{0x6b, 0xd8, 0xcc, 0xac, 0x71, 0x77, 0x44, 0x17, 0xfe, 0xe0, 0xde, 0xda, 0xd5, 0x97, 0x6e, 0x69, 0xeb, 0xe9, 0xdd, 0x80, 0x1d, 0x4b, 0x51, 0xf1, 0x5b, 0xf3, 0x4a, 0x93, 0x27, 0x32, 0x2c, 0xb0}, //nolint:lll
			},
...
func Test_Node_EncodeAndHashRoot(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"small leaf encoding": {
			...
			expectedNode: Node{
				NodeValue: []byte{0x60, 0x51, 0x6d, 0xb, 0xb6, 0xe1, 0xbb, 0xfb, 0x12, 0x93, 0xf1, 0xb2, 0x76, 0xea, 0x95, 0x5, 0xe9, 0xf4, 0xa4, 0xe7, 0xd9, 0x8f, 0x62, 0xd, 0x5, 0x11, 0x5e, 0xb, 0x85, 0x27, 0x4a, 0xe1}, //nolint:lll
			},
			encoding: []byte{0x41, 0x1, 0x4, 0x2},
		...
		"small branch encoding": {
			...
			expectedNode: Node{
				Children:  make([]*Node, ChildrenCapacity),
				NodeValue: []byte{0x48, 0x3c, 0xf6, 0x87, 0xcc, 0x5a, 0x60, 0x42, 0xd3, 0xcf, 0xa6, 0x91, 0xe6, 0x88, 0xfb, 0xdc, 0x1b, 0x38, 0x39, 0x5d, 0x6, 0x0, 0xbf, 0xc3, 0xb, 0x4b, 0x5d, 0x6a, 0x37, 0xd9, 0xc5, 0x1c}, //nolint:lll
			},
			encoding: []byte{0xc1, 0x1, 0x0, 0x0, 0x4, 0x2},
