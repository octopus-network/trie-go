...
func TestBlake2b218_EmptyHash(t *testing.T) {
	...
	in := []byte{}
	h, err := util.Blake2b128(in)
	require.NoError(t, err)

	expected, err := util.HexToBytes("0xcae66941d9efbd404e4d88758ea67670")
	require.NoError(t, err)
...
func TestBlake128(t *testing.T) {
	...
	expected, err := util.HexToBytes("0x440973e4e50902f1d0ec97de357eb2fd")
	require.NoError(t, err)
	require.Equal(t, expected, h)
}
...
func Test_MustBlake2b8(t *testing.T) {
	...
	digest := util.MustBlake2b8([]byte("TaggedTransactionQueue"))
...
func TestKeccak256_EmptyHash(t *testing.T) {
	...
	in := []byte{}
	h, err := util.Keccak256(in)
	require.NoError(t, err)

	expected, err := util.HexToHash("0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470")
	require.NoError(t, err)
	require.Equal(t, expected, h)
}
...
func TestKeccak256(t *testing.T) {
	...
	expected, err := util.HexToHash("0xd517392f8119f79c1623774b9346e00104a1d193f1fa641e6e659bf323c37967")
	require.NoError(t, err)
	require.Equal(t, expected, h)
}
